 ...
 **************************************************************** **/
	function _owl_carousel() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path + 'libraryJs/sliderJs/owl.carousel.min.js', function() {
 ...
 **************************************************************** **/
	function _lightbox() {
		...
		if(_el.length > 0) {
			...
			loadScript(plugin_path + 'libraryJs/magnific-popup/jquery.magnific-popup.min.js', function() {
 ...
 **************************************************************** **/
	function _mixitup() {
		...
		if(_container.length > 0) {
			loadScript(plugin_path + 'libraryJs/mixitup/jquery.mixitup.min.js', function() {
 ...
 **************************************************************** **/
	function _misc() {
		...
		if(portfolio_isotope_container.length > 0) {
			loadScript(plugin_path + 'libraryJs/isotope/isotope.pkgd.min.js', function() {
		...
		if(file_container.length > 0) {
			loadScript(plugin_path + 'libraryJs/custom.fle_upload.js');
		}
 ...
 **************************************************************** **/
	function _widget_twitter() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path + 'libraryJs/widget.twittie/twittie.min.js', function() {
